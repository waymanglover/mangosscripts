-- Generated by GenerateElunaEnums on 10/9/2018 1:01:41 AM
...
RegisterTypes = readOnlyTable {
  ...
  REGTYPE_CREATURE = 5,
  REGTYPE_VEHICLE = 6,
  REGTYPE_CREATURE_GOSSIP = 7,
  REGTYPE_GAMEOBJECT = 8,
  REGTYPE_GAMEOBJECT_GOSSIP = 9,
  REGTYPE_ITEM = 10,
  REGTYPE_ITEM_GOSSIP = 11,
  REGTYPE_PLAYER_GOSSIP = 12,
  REGTYPE_BG = 13,
  REGTYPE_MAP = 14,
  REGTYPE_INSTANCE = 15,
  REGTYPE_COUNT = 16,
...
ServerEvents = readOnlyTable {
  ...
  SERVER_EVENT_COUNT = 36,
}

PlayerEvents = readOnlyTable {
  ...
  PLAYER_EVENT_COUNT = 43,
}

GuildEvents = readOnlyTable {
...
GameObjectEvents = readOnlyTable {
